...
import com.mariodev.novelapp.adapters.PostCommentAdapter;
...
public class PostCommentsReplyActivity extends AppCompatActivity implements PostCommentAdapter.OnDeleteClickListener {
    SharedPref sharedPref;

    String postId, userId, commentId, userReplyId, userCommentText, userCommentDateTime, replyCountText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_comments_reply);
        ...
        replyRef = FirebaseDatabase.getInstance().getReference("Posts")
        ...
        allRepliesRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    postCommentAdapter = new PostCommentAdapter(PostCommentsReplyActivity.this,
                            commentModelList,"reply");
                    commentsRecycler.setAdapter(postCommentAdapter);
                    commentsRecycler.smoothScrollToPosition(commentModelList.size() - 1);
                    postCommentAdapter.notifyDataSetChanged();
                    postCommentAdapter.setOnDeleteClickListener(PostCommentsReplyActivity.this);
    ...
    private void sendComment() {
        ...
        commentModel.setPoemOrPostId(postId);
    ...
    public void onDeleteClick(final int position, final List<CommentModel> modelList) {
        deletedReplyRef = FirebaseDatabase.getInstance().getReference("Posts")
                .child(postId).child("comments");

        AlertDialog.Builder builder = new AlertDialog.Builder(PostCommentsReplyActivity.this , R.style.DialogTheme);
