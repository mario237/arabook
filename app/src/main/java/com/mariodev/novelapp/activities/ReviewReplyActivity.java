...
public class ReviewReplyActivity extends AppCompatActivity implements ReviewsAdapter.OnDeleteClickListener{

    SharedPref sharedPref;

    String storyId, userId, chapterId, commentId, userReplyId, userCommentText, userCommentDateTime, replyCountText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        replyRef = FirebaseDatabase.getInstance().getReference("Novels")
                .child("ReviewsReply").child(commentId);
        ...
        allRepliesRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    reviewsAdapter = new ReviewsAdapter(ReviewReplyActivity.this, commentModelList);
                    commentsRecycler.setAdapter(reviewsAdapter);
                    commentsRecycler.smoothScrollToPosition(commentModelList.size() - 1);
                    reviewsAdapter.notifyDataSetChanged();
                    reviewsAdapter.setOnDeleteClickListener(ReviewReplyActivity.this);
    ...
    public void onDeleteClick(final int position, final List<CommentModel> modelList) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ReviewReplyActivity.this , R.style.DialogTheme);
