...
public class ChapterCommentsActivity extends AppCompatActivity implements ChapterCommentAdapter.OnDeleteClickListener{
    SharedPref sharedPref;

    String storyId, chapterId, userId;
    ImageView arrowBack;
    ...
    ChapterCommentAdapter commentAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commentRef = FirebaseDatabase.getInstance().getReference("Novels")
                .child("Chapters").child(storyId).child(chapterId).child("comments");
        ...
        commentRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    commentAdapter = new ChapterCommentAdapter(ChapterCommentsActivity.this,
                            commentModelList , "comments");
                    commentsRecycler.setAdapter(commentAdapter);
                    commentsRecycler.smoothScrollToPosition(commentModelList.size() - 1);
                    commentAdapter.notifyDataSetChanged();
                    commentAdapter.setOnDeleteClickListener(ChapterCommentsActivity.this);
    ...
    public void onDeleteClick(final int position, final List<CommentModel> modelList) {
        ...
        deletedCommentRef = FirebaseDatabase.getInstance().getReference("Novels").child("Chapters").child(storyId).child(chapterId).child("comments");

        AlertDialog.Builder builder = new AlertDialog.Builder(ChapterCommentsActivity.this , R.style.DialogTheme);
