...
import com.mariodev.novelapp.adapters.PoemCommentAdapter;
...
public class PoemCommentsReplyActivity extends AppCompatActivity implements PoemCommentAdapter.OnDeleteClickListener{
    SharedPref sharedPref;

    String poemId, userId, commentId, userReplyId, userCommentText, userCommentDateTime, replyCountText;
    ...
    PoemCommentAdapter poemCommentAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_poem_comments_reply);
        ...
        replyRef = FirebaseDatabase.getInstance().getReference("Poems")
                .child(poemId).child("comments").child(commentId);
        ...
        allRepliesRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    poemCommentAdapter = new PoemCommentAdapter(PoemCommentsReplyActivity.this,
                            commentModelList , "reply");
                    commentsRecycler.setAdapter(poemCommentAdapter);
                    commentsRecycler.smoothScrollToPosition(commentModelList.size() - 1);
                    poemCommentAdapter.notifyDataSetChanged();
                    poemCommentAdapter.setOnDeleteClickListener(PoemCommentsReplyActivity.this);
    ...
    private void sendComment() {
        ...
        commentModel.setPoemOrPostId(poemId);
    ...
    public void onDeleteClick(final int position, final List<CommentModel> modelList) {
        deletedReplyRef = FirebaseDatabase.getInstance().getReference("Poems")
                .child(poemId).child("comments");


        AlertDialog.Builder builder = new AlertDialog.Builder(PoemCommentsReplyActivity.this , R.style.DialogTheme);
