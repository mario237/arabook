...
public class PoemCommentsActivity extends AppCompatActivity implements PoemCommentAdapter.OnDeleteClickListener{
    SharedPref sharedPref;

    String poemId , userId;
    ImageView arrowBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_poem_comments);
        ...
        commentRef = FirebaseDatabase.getInstance().getReference("Poems")
        ...
        commentRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    poemCommentAdapter = new PoemCommentAdapter(PoemCommentsActivity.this,
                    ...
                    poemCommentAdapter.setOnDeleteClickListener(PoemCommentsActivity.this);
    ...
    public void onDeleteClick(final int position, final List<CommentModel> modelList) {
        deletedCommentRef =FirebaseDatabase.getInstance().getReference("Poems")
                .child(poemId).child("comments");

        AlertDialog.Builder builder = new AlertDialog.Builder(PoemCommentsActivity.this , R.style.DialogTheme);
