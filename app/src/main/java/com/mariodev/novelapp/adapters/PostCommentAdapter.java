...
import com.mariodev.novelapp.activities.PostCommentsReplyActivity;
...
public class PostCommentAdapter extends RecyclerView.Adapter<PostCommentAdapter.ViewHolder> {
    ...
    public PostCommentAdapter(Context context, List<CommentModel> commentModelList, String whichActivity) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        allRepliesRef = FirebaseDatabase.getInstance().getReference("Posts")
    ...
    private void goToReply(CommentModel commentModel){
        Intent intent = new Intent(context , PostCommentsReplyActivity.class);
        intent.putExtra("postId",commentModel.getPoemOrPostId());
