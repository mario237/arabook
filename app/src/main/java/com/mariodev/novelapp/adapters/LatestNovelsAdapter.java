...
public class LatestNovelsAdapter extends RecyclerView.Adapter<LatestNovelsAdapter.ViewHolder> {
    ...
    public LatestNovelsAdapter(Context context, List<StoryModel> storyModelList) {
