...
import com.mariodev.novelapp.activities.ChapterCommentReplyActivity;
...
public class ChapterCommentAdapter extends RecyclerView.Adapter<ChapterCommentAdapter.ViewHolder> {
    ...
    public ChapterCommentAdapter(Context context, List<CommentModel> commentModelList, String whichActivity) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        allRepliesRef =FirebaseDatabase.getInstance().getReference("Novels")
                .child("Chapters").child(commentModel.getStoryId()).child(commentModel.getChapterId()).child("comments")
    ...
    private void goToReply(CommentModel commentModel){
        Intent intent = new Intent(context , ChapterCommentReplyActivity.class);
