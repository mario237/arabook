...
import com.mariodev.novelapp.activities.PoemCommentsReplyActivity;
...
public class PoemCommentAdapter extends RecyclerView.Adapter<PoemCommentAdapter.ViewHolder> {
    ...
    public PoemCommentAdapter(Context context, List<CommentModel> commentModelList, String whichActivity) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        allRepliesRef = FirebaseDatabase.getInstance().getReference("Poems")
    ...
    private void goToReply(CommentModel commentModel){
        Intent intent = new Intent(context , PoemCommentsReplyActivity.class);
        intent.putExtra("poemId",commentModel.getPoemOrPostId());
