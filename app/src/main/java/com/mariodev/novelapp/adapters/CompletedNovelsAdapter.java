...
public class CompletedNovelsAdapter extends RecyclerView.Adapter<CompletedNovelsAdapter.ViewHolder> {
    ...
    public CompletedNovelsAdapter(Context context, List<StoryModel> storyModelList) {
