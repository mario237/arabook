...
import com.mariodev.novelapp.activities.DraftStoryDetailsActivity;
...
public class DraftAdapter extends RecyclerView.Adapter<DraftAdapter.ViewHolder> {
    ...
    private final List<StoryModel> mDraftsList;


    public DraftAdapter(Context mContext, Activity mActivity, List<StoryModel> mDraftsList) {
        this.mContext = mContext;
        this.mActivity = mActivity;
        this.mDraftsList = mDraftsList;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        final StoryModel storyModel =mDraftsList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intentToStoryDetails = new Intent(mContext , DraftStoryDetailsActivity.class);
